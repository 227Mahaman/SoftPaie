...
$user = file_get_contents(ROOT_PATH."index.php/getUser/".$id);
            ...
            <div class="clearfix">
                ...
                <div class="profile-left">
                    ...
                    <div class="profile-header">
                        ...
                        <div class="profile-main">
                            ...
                            <h3 class="name"><?= $_SESSION['user-auth']['pseudo'];?></h3>
                            <span class="online-status status-available"><?= $_SESSION['user-auth']['typeUser'];?></span>
                        </div>
                    ...
                    <div class="profile-detail">
                        <div class="profile-info">
                            <h4 class="heading">Information de Base</h4>
                            <ul class="list-unstyled list-justify">
                                <li>Pseudo <span><?= $user['0']['pseudo']?></span></li>
                ...
                <div class="profile-right">
                    ...
                    <div class="awards">
                        ...
                        <div class="text-center"><a href="index.php?p=compte" class="btn btn-primary">Editer Compte Entreprise</a></div>
                    </div>
                    <!-- END AWARDS -->
                    <!-- TABBED CONTENT -->
